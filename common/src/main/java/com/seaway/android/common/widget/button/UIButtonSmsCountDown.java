package com.seaway.android.common.widget.button;
...
public class UIButtonSmsCountDown extends Button {
	...
	private void initView() {
		...
		this.setBackgroundResource(R.drawable.sms_code_butn_bg);
	...
	public void setEnabled(boolean enabled) {
		...
		SWLog.LogD("set enabled");
		SWLog.LogD("this.millisInFuture is : " + this.millisInFuture);
		SWLog.LogE("enabled="+enabled);
		SWLog.LogE("enableText="+enableText);
		if (enabled) {
			...
			if (SWVerificationUtil.isEmpty(enableText)) {
	...
	public Parcelable onSaveInstanceState() {
		// TODO Auto-generated method stub
		SWLog.LogD("UIButtonSmsCountDown onSaveInstanceState ");
	...
	public void onDetachedFromWindow() {
		...
		SWLog.LogD("UIButtonSmsCountDown onDetachedFromWindow");
		if (null != timeCount) {
			timeCount.cancel();
			timeCount = null;
		}
