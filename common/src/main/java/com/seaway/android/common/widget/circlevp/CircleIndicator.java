/**********************************************************************
 * FILE                ：CirclePageIndicator.java
 * PACKAGE			   ：com.xbting.circle.vp.widget
 * AUTHOR              ：xubt
 * DATE				   ：2014-7-21 下午4:28:37
 * FUNCTION            ：
 *
 * 杭州思伟版权所有
 *======================================================================
...
/**
 * 项目名称:CircleViewPage
 * 类名称:CirclePageIndicator
 * 类描述：viewpage item指示器
 * 创建人：xubt
 * 创建时间:2014-7-21 下午4:28:37
 * -------------------------------修订历史--------------------------
 * 修改人：xubt
 * 修改时间:2014-7-21 下午4:28:37
 * 修改备注：
 * @version：
 */
public class CircleIndicator extends View implements OnPageChangeListener{
	...
	public void setCircleViewPager(CircleViewPager mCircleViewPager) {
		SWLog.LogE("CircleIndicator---setCircleViewPager");
	 ...
	 */
	private void init() {
		SWLog.LogD("CircleIndicator---init");
