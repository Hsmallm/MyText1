...
import com.example.administrator.text1.utils.view.FixRatioImageView;
...
public class TestActivity1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTheme(R.style.TestActivity1);
        setContentView(R.layout.activity_test_base);

        txtTitle = (TextView) findViewById(R.id.title);
        img = (FixRatioImageView) findViewById(R.id.img);
        img.setImageResource(R.drawable.chart);
        txtDescribe = (TextView) findViewById(R.id.describe);
        txtDescribe.setText("Activity1");
        btn = (Button) findViewById(R.id.btn);
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(TestActivity2.newIntent(TestActivity1.this));
            }
        });
    }
}
