...
public class NetworkingUtil {
    ...
    public static boolean checkNetworking(Context context) {
        if (-1 == checkNetworkingState(context)) {
            return false;
        }
        return true;
    }
     ...
     */
    public static int checkNetworkingState(Context context) {
    ...
    public static int isCTWAP(Context context) {
        ...
        if (cursor.moveToFirst()) {
            ...
            LogUtil.i("TAG", "user is : " + user);
            LogUtil.i("TAG", "proxy is : " + proxy);
