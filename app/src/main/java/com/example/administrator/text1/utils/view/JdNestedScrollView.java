...
// */
//public class JdNestedScrollView extends FrameLayout implements NestedScrollingParent,
...
//
//
//    public JdNestedScrollView(Context context) {
//        this(context, null);
//    }
//
//    public JdNestedScrollView(Context context, AttributeSet attrs) {
//        this(context, attrs, 0);
//    }
//
//    public JdNestedScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                measureChild(getChildAt(1), widthMeasureSpec, MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY));
//                measureChild(getChildAt(0), widthMeasureSpec, MeasureSpec.makeMeasureSpec(height, MeasureSpec.EXACTLY));
...
//            onPageSelectedListener.onUpdateScrollPosition(1f*getScrollY()/getHeight());
//        }
////        Log.e("Scroll", "OldT:"+oldt+"   T:"+t+"   "+mScroller.isFinished());
//    }
//
//    @Override
//    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
...
//                if (yDiff > 2*mTouchSlop && yDiff>2*xDiff
...
//        if (!result && ev.getAction() == MotionEvent.ACTION_CANCEL || ev.getAction() == MotionEvent.ACTION_UP) {
//            post(new Runnable() {
//                @Override
//                public void run() {
//                    if (mScroller.isFinished()) {
...
//            @Override
//            public void run() {
//                if(isFirstPage && getScrollY()!=0){
//                    smoothScrollTo(0, 0);
//                }else if(!isFirstPage && getScrollY()!=h){
//                    smoothScrollTo(0, getMeasuredHeight());
//                }
//            }
//        }, 500);
...
//            handler.postDelayed(runnable, DEFAULT_DURATION);
//        }
//    }
//
...
//                return true;
//            }
//            final JdNestedScrollView nsvHost = (JdNestedScrollView) host;
...
//         */
//        void onUpdateScrollPosition(float position);
//    }
//}
