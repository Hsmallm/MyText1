...
public class CustomCookieJar implements CookieJar {
    ...
    private static final String TAG = CustomCookieJar.class.getName();
    ...
    public void saveFromResponse(HttpUrl url, List<Cookie> cookies) {
        if (cookieHandler != null) {
            ...
            try {
                ...
                LogUtil.w(TAG,"Saving cookies failed for " + url.resolve("/..."));
            }
        }
    }
    ...
    public List<Cookie> loadForRequest(HttpUrl url) {
        ...
        try {
            ...
            LogUtil.w(TAG, "Loading cookies failed for " + url.resolve("/..."));
